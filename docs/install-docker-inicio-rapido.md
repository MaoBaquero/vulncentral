...
Las credenciales de acceso tras el seed dependen del script de semilla del repositorio; consulta la sección «Entrar a aplicativo» en [Inicio rápido](Inicio_Rapido.md).
